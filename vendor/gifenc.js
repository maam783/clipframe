/* gifenc 1.0.3 (MIT, Matt DesLauriers) — vendored. See vendor/gifenc.LICENSE.md.
   UMD shim added by Clipframe so the esbuild CJS bundle exposes a global `gifenc`
   in both window and Worker scope (lets `importScripts('vendor/gifenc.js')` work
   with no module loader, per the no-build-step / vendored hard rule). */
